...
The test dataset contains data related to three main domains – Personal, Work and Academia. Table 6.2 shows the classification spit up of the different domains. Using the formulae mentioned above, the domain-wise metrics can be obtained.
